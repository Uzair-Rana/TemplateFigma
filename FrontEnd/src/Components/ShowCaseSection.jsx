...
const PortfolioCard = ({ category, title, imageUrl, alt }) => (
  ...
  `}>
      ...
      Tablet:h-48 Mobile:h-36
    `}>
            <img className={`${twConfig.showcaseSection.card.image} object-cover w-full h-full`} src={imageUrl} alt={alt} />
        </div>
...
export default function ShowCaseSection() {
    ...
    `}>
          ...
          Tablet:mb-8 Mobile:mb-4 flex-col
        `}>
                    <h1 className={`
          ...
          Tablet:grid-cols-2 Tablet:gap-x-6 Tablet:gap-y-10
          Mobile:grid-cols-1 Mobile:gap-x-4 Mobile:gap-y-6
        `}>
